...
class PagesController extends Controller
{
  ...
  public function account_settings()
  {
    ...
    return view('/admin/content/pages/page-account-settings', ['breadcrumbs' => $breadcrumbs]);
  }
  ...
  public function profile()
  {
    ...
    return view('/admin/content/pages/page-profile', ['breadcrumbs' => $breadcrumbs]);
  }
  ...
  public function faq()
  {
    ...
    return view('/admin/content/pages/page-faq', ['breadcrumbs' => $breadcrumbs]);
  }
  ...
  public function knowledge_base()
  {
    ...
    return view('/admin/content/pages/page-knowledge-base', ['breadcrumbs' => $breadcrumbs]);
  }
  ...
  public function kb_category()
  {
    ...
    return view('/admin/content/pages/page-kb-category', ['breadcrumbs' => $breadcrumbs]);
  }
  ...
  public function kb_question()
  {
    ...
    return view('/admin/content/pages/page-kb-question', ['breadcrumbs' => $breadcrumbs]);
  }
  ...
  public function pricing()
  {
    ...
    return view('/admin/content/pages/page-pricing', ['pageConfigs' => $pageConfigs]);
  }
  ...
  public function blog_list()
  {
    ...
    return view('/admin/content/pages/page-blog-list', ['breadcrumbs' => $breadcrumbs, 'pageConfigs' => $pageConfigs]);
  }
  ...
  public function blog_detail()
  {
    ...
    return view('/admin/content/pages/page-blog-detail', ['breadcrumbs' => $breadcrumbs, 'pageConfigs' => $pageConfigs]);
  }
  ...
  public function blog_edit()
  {
    ...
    return view('/admin/content/pages/page-blog-edit', ['breadcrumbs' => $breadcrumbs]);
  }
}
